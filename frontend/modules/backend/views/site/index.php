...
AppAsset_b::addScript($this, 'assets/plugins/countTo/jquery.countTo.js');
AppAsset_b::addScript($this, 'assets/plugins/weather/js/skycons.js');
AppAsset_b::addScript($this, 'assets/plugins/flot/js/jquery.flot.min.js');
AppAsset_b::addScript($this, 'assets/plugins/flot/js/jquery.flot.resize.min.js');
AppAsset_b::addScript($this, 'assets/plugins/flot/js/jquery.flot.canvas.min.js');
AppAsset_b::addScript($this, 'assets/plugins/flot/js/jquery.flot.image.min.js');
AppAsset_b::addScript($this, 'assets/plugins/flot/js/jquery.flot.categories.min.js');
AppAsset_b::addScript($this, 'assets/plugins/flot/js/jquery.flot.crosshair.min.js');
AppAsset_b::addScript($this, 'assets/plugins/flot/js/jquery.flot.errorbars.min.js');
AppAsset_b::addScript($this, 'assets/plugins/flot/js/jquery.flot.fillbetween.min.js');
AppAsset_b::addScript($this, 'assets/plugins/flot/js/jquery.flot.navigate.min.js');
AppAsset_b::addScript($this, 'assets/plugins/flot/js/jquery.flot.pie.min.js');
AppAsset_b::addScript($this, 'assets/plugins/flot/js/jquery.flot.selection.min.js');
AppAsset_b::addScript($this, 'assets/plugins/flot/js/jquery.flot.stack.min.js');
AppAsset_b::addScript($this, 'assets/plugins/flot/js/jquery.flot.symbol.min.js');
AppAsset_b::addScript($this, 'assets/plugins/flot/js/jquery.flot.threshold.min.js');
AppAsset_b::addScript($this, 'assets/plugins/flot/js/jquery.colorhelpers.min.js');
AppAsset_b::addScript($this, 'assets/plugins/flot/js/jquery.flot.time.min.js');
AppAsset_b::addScript($this, 'assets/plugins/flot/js/jquery.flot.example.js');
...
AppAsset_b::addScript($this, 'assets/plugins/jvectormap/js/jquery-jvectormap-1.2.2.min.js');
AppAsset_b::addScript($this, 'assets/plugins/jvectormap/js/jquery-jvectormap-world-mill-en.js');
AppAsset_b::addScript($this, 'assets/plugins/todo/js/todos.js');
AppAsset_b::addCss($this, 'assets/plugins/jvectormap/css/jquery-jvectormap-1.2.2.css');
AppAsset_b::addCss($this, 'assets/plugins/todo/css/todos.css');
AppAsset_b::addCss($this, 'assets/plugins/morris/css/morris.css');
?>
<div id="main-content">
    <!--tiles start-->
    <div class="row">

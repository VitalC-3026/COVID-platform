...
<form id="setup" method="post" novalidate="novalidate">
    <table class="form-table" role="presentation">
        ...
        <tr>
            ...
            <td>
                <?php
                if (isset($_POST["chose"]) && $_POST["chose"] == "sample") {
                    echo "<label><input name=\"chose\" type=\"radio\" value=\"sample\" checked/>简洁 </label>
        <label><input name=\"chose\" type=\"radio\" value=\"complete\" />完整 </label>";

                    } else {
                    echo "<label><input name=\"chose\" type=\"radio\" value=\"sample\"/>简洁 </label>
